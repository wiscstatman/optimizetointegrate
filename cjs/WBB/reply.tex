...
\answer{Thanks for the suggestion. We have added a regression simulation study with different combinations of $(p,n)$ in both sparse and non-sparse settings. Your comment also led us to add extra individual weights into the penalty. This helps in the large $p$ case.}
\end{enumerate}
