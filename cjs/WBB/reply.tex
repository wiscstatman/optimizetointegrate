...
\answer{Thanks for your very good point.  It led us to reconsider how to deal with the case $p>n$. We now add a separate weight on each penalty term to mitigate the problem you 
identified, although the problem is not completely eliminated.
 We have added a simulation study to illustrate your point -- we used Bayesian LASSO.}
