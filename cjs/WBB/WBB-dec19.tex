...
related to the original Bayesian bootstrap (Rubin, 1981; Muliere \& Secci, 1996), 
...
To further illustrate the WBB methodology, we apply it to the often-analyzed diabetes dataset (Efron et al., 2004). Data from $n=442$ diabetes patients are available, with 10 baseline variables ($p=10$), including age, sex, body mass index, average blood pressure, and six blood serum measurements. 
 We apply Algorithm~1 with $T=1000$. For each weight vector ${\bf w}$, the WBB estimate $\beta^*_{\bf w}$ is calculated using Equation (\ref{eqn:diabetes}) via the regularization method in the package {\tt glmnet}. 
...
\bibitem[Klein2012]
Klein, B. J. K. \& van der Vaart, A. W. (2012). The Bernstien-von-Mises theorem
