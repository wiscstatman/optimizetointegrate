...
Results for estimation error,  out-of-sample prediction error, credible interval coverage and model-selection discrepancy are displayed in Table (1), (2), (3) and (4), respectively. In almost all cases when $p\geq 60$, WBB has lower estimation error than BLASSO. 
...
Though limited in scope, this simulation reveals broad similarities between WBB and Bayesian LASSO in both 
posterior structure and the sampling performance of approximate posterior summaries. It may provide
