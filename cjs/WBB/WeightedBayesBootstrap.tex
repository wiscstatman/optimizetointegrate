...
\title{Weighted Bayesian Bootstrap for Scalable Posterior Distributions}
...
Given the i.i.d. exponential weights $w_0$ and $w_1$, the weighted posterior mode $\theta^*_{\bf w}$ is given by 
$$
