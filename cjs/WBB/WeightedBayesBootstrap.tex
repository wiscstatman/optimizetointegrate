...
When optimization on the original problem~(\ref{eqn:canonicalform}) is fast and scalable, so too is the WBB. 
...
Centering on the posterior mode, rather than the MLE, improves accuracy in many cases ({\em ?citation?}).   
