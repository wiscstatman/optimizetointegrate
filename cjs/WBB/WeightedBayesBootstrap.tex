...
See Wright (2015), or  Hastie, Tibshirani, and Wainwright (2015), chapter 5, for a statistical perspective.
The optimization literature also characterizes $\theta^*$ as the fixed point of a proximal operator
$\theta^* = \prox_{\gamma \phi}\{ \theta^* - \lambda \nabla f(\theta^*) \} $, which opens the door to powerful MM algorithms.
See Lange (2016, chap 5) and Polson \& Scott (2015a, 2015b).
 for further discussion.   **?something on theory of non-convex?** 
...
* on code systems* TensorFlow ...Keras...glmnet...genlasso...
  ...
  {\tt glmnet} Friedman {\em et al.} (2010);  
and {\tt genlasso} 
 Arnold \& Tibshirani, (2014)
