...
=======
	&       $\beta$              & $p$      & 40   & 60   & 80   & 100  & 120  \\ \colrule
		\multirow{6}{*}{$n = 50$}  & \multirow{2}{*}{A(i)}  & BLASSO & 0.13   & 0.10   & 0.06   & 0.05   & 0.05   \\
		&                        & WBB    & 0.18   & 0.06   & 0.05   & 0.04   & 0.03   \\ 
		& \multirow{2}{*}{A(ii)} & BLASSO & 5.70   & 3.81   & 2.86   & 2.41   & 1.91   \\
		&                        & WBB    & 7.02   & 3.01   & 2.21   & 1.84   & 1.57   \\
		& \multirow{2}{*}{B}     & BLASSO & 0.69   & 0.70   & 0.69   & 0.79   & 0.81   \\
		&                        & WBB    & 1.41   & 0.50   & 0.52   & 0.54   & 0.55   \\  \colrule
		\multirow{6}{*}{$n = p/2$} & \multirow{2}{*}{A(i)}  & BLASSO & 0.13   & 0.08   & 0.06   &   -     & 0.04   \\
		&                        & WBB    & 0.13   & 0.07   & 0.05   &  -      & 0.03   \\ 
		& \multirow{2}{*}{A(ii)} & BLASSO & 7.05   & 4.23   & 2.95   &  -      & 1.92   \\
		&                        & WBB    & 6.15   & 3.86   & 2.51   &  -      & 1.52   \\ 
		& \multirow{2}{*}{B}     & BLASSO & 0.55   & 0.60   & 0.69   &  -      & 0.80   \\
		&                        & WBB    & 0.66   & 0.60   & 0.57   &  -      & 0.51   \\ \botrule
>>>>>>> origin/master
\end{tabular*}}
\end{table}	
...
=======
	&      $\beta$               & $p$      & 40   & 60   & 80   & 100  & 120  \\ \colrule	
		\multirow{6}{*}{$n = 50$}  & \multirow{2}{*}{A(i)}  & BLASSO & 3.21   & 3.29   & 3.63   & 3.71   & 3.84   \\
		&                        & WBB    & 3.20   & 3.25   & 3.61   & 3.63   & 3.83   \\ 
		& \multirow{2}{*}{A(ii)} & BLASSO & 120.22 & 129.77 & 129.21 & 130.59 & 133.64 \\
		&                        & WBB    & 121.30 & 128.89 & 129.40 & 133.55 & 138.04 \\ 
		& \multirow{2}{*}{B}     & BLASSO & 19.98  & 33.12  & 47.18  & 63.50  & 80.49  \\
		&                        & WBB    & 20.26  & 32.60  & 47.09  & 63.65  & 77.51  \\  \colrule
		\multirow{6}{*}{$n = p/2$} &  \multirow{2}{*}{A(i)} & BLASSO & 4.57   & 3.92   & 4.05   &  -      & 3.47   \\
		&                        & WBB    & 3.84   & 3.55   & 3.94   &  -      & 3.53   \\ 
		& \multirow{2}{*}{A(ii)}  & BLASSO & 184.01 & 151.70 & 142.93 &  -      & 128.91 \\
		&                        & WBB    & 150.67 & 136.02 & 140.68 &  -      & 134.78 \\ 
		& \multirow{2}{*}{B}      & BLASSO & 27.93  & 37.57  & 51.24  &  -      & 76.36  \\
		&                        & WBB    & 23.36  & 34.10  & 47.31  &  -      & 79.15  \\ \botrule
>>>>>>> origin/master
	\end{tabular*}}
\end{table}
...
=======
	&        $\beta$                & $p$      & 40   & 60   & 80   & 100  & 120  \\ \colrule
		\multirow{6}{*}{$n = 50$}  & \multirow{2}{*}{A(i)}  & BLASSO & 0.91 & 0.93 & 0.93 & 0.94 & 0.95 \\
		&                        & WBB    & 0.90 & 0.91 & 0.92 & 0.94 & 0.94 \\ 
		& \multirow{2}{*}{A(ii)} & BLASSO & 0.91 & 0.93 & 0.95 & 0.96 & 0.96 \\
		&                        & WBB    & 0.91 & 0.92 & 0.93 & 0.94 & 0.95 \\ 
		& \multirow{2}{*}{B}     & BLASSO & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 \\
		&                        & WBB    & 0.95 & 0.95 & 0.93 & 0.91 & 0.88 \\ \colrule
		\multirow{6}{*}{$n = p/2$} & \multirow{2}{*}{A(i)}  & BLASSO & 0.94 & 0.94 & 0.94 &  -    & 0.94 \\
		&                        & WBB    & 0.91 & 0.92 & 0.93 & -     & 0.94 \\
		& \multirow{2}{*}{A(ii)} & BLASSO & 0.92 & 0.94 & 0.95 & -     & 0.96 \\
		&                        & WBB    & 0.90 & 0.92 & 0.93 & -     & 0.95 \\
		& \multirow{2}{*}{B}     & BLASSO & 1.00 & 1.00 & 1.00 & -     & 1.00 \\
		&                        & WBB    & 0.90 & 0.91 & 0.91 & -     & 0.90 \\  \botrule
>>>>>>> origin/master
	\end{tabular*}}
\end{table}
...
\begin{table}[ht]
	...
	\tbl{Model-selection Discrepancy Posterior Mean}{%
\begin{tabular*}{30pc}{@{\hskip5pt}@{\extracolsep{\fill}}c@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}@{\hskip5pt}}
\toprule
	&                        & $p$      & 40   & 60   & 80   & 100  & 120  \\ \colrule
...
Results for estimation error,  out-of-sample prediction error, credible interval coverage and model-selection discrepancy are displayed in Table (1), (2), (3) and (4), respectively. In almost all cases when $p\geq 60$, WBB has lower estimation error than BLASSO does. It also outperforms BLASSO in terms of out-of-sample prediction in general. The latter makes better predictions when $p\geq 100$ and the sparse $\beta$ is not uniform across those non-zero coordinates. Credible intervals of neither WBB nor BLASSO has exact 95\% coverages.  WBB performs well when $p \geq 100$ and $\beta$ is sparse, though it always gives narrow intervals.  When $\beta_j = 1$ for all $1 \leq j \leq p$, BLASSO intervals are too wide while WBB intervals have coverage close to 95\% when $40 \leq p \leq 80$. In terms of model selection, we observe that WBB beats BLASSO in all sparse cases. WBB posterior mean of model-selection discrepancy is significantly smaller than that of BLASSO. However, its performance gets worse when $\beta$ is dense and uniform. 
