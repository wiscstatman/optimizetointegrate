...
\jid{CJS}
\aid{???}
% The running head contains the author names: remove the blinding now!
\rhauthor{AuthorA and AuthorB}
...
\author{AuthorA\authorref{1}\thanksref{*}}
\author{AuthorB\authorref{2}}
...
\correspondingauthor[*]{\\\email{Insert your email address here}}
...
Place all acknowledgements here.  Granting agencies should not be abbreviated, and do not include grant numbers.  We are grateful for your assistance with our publication process.\\
\\
