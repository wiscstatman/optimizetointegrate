...
The plot below shows one conditional distribution (smoothed) from normalizing urn $U_z$ where $z$ is the 200$th$ order statistic, which
...
w <- env2[200,]/sum( env2[200,] )
k200 <- density( x.to.o2, weights=w ) 
plot(k200,main="normalized measure at one z[from]", xlab="z[to]")
```

#### Markov Bayesian Bootstrap 

*how to make the matrix of weights*
